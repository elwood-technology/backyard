...
CREATE TABLE "storage"."access" (
  ...
  "permission" storage.access_permission ARRAY NOT NULL DEFAULT array['READ']::storage.access_permission[],
  UNIQUE ("id")
);

CREATE UNIQUE INDEX storage_access_idx ON "storage"."access" USING btree ("bucket", "path", "user_id");
